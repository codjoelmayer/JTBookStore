            ...
            <div class="modal-body ">
              <form class="form" @submit.prevent="addOrUpdateUser">
                  <div class="form-control-wrapper">  
                    <span class="inline">
                      <input class="form-control" type="text" placeholder="Firstname" required v-model="firstName"/>   
                  ...
                  <div class="form-control-wrapper">  
                      <span class="inline">
                        <input type="text" class="form-control" placeholder="Cellphone" v-model="cellphone" maxlength="10">
                  ...
                  <div class="form-control-wrapper" v-show="this.isAdmin">  
                      <span class="inline">
                        <input type="text" class="form-control" placeholder="user / admin" v-model="userRole">
                        <i class="bi bi-person"></i>
                      </span>        
                  </div>
                  <div class="form-control-wrapper">  
                  ...
                  <div class="form-control-wrapper">  
                    <label class="form-control bg-gradient" v-show="usrMsg">{{usrMsg}}</label>
                  </div>
                  <div class="form-control-wrapper">  
